...
def trainPPO(player, enemy, env, save_interval, load, T_horizon, Max_train_steps, random_player=False, random_enemy=False): # PPO using XinJingHao's implementation
    ...
    if not random_player:
        ...
        plot_multiple_lists([total_player_actor_losses], "Training Steps (minibatch)", "Player Actor Loss", ["Player Actor Loss"], "player_actor_loss.png")
        ...
        plot_multiple_lists([total_player_critic_losses], "Training Steps (minibatch)", "Player Critic Loss", ["Player Critic Loss"], "player_critic_loss.png")
    ...
    if not random_enemy:
        ...
        plot_multiple_lists([total_enemy_actor_losses], "Training Steps (minibatch)", "Enemy Actor Loss", ["Enemy Actor Loss"], "enemy_actor_loss.png")
        ...
        plot_multiple_lists([total_enemy_critic_losses], "Training Steps (minibatch)", "Enemy Critic Loss", ["Enemy Critic Loss"], "enemy_critic_loss.png")
